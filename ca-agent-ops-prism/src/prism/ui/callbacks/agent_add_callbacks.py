...
@typed_callback(
    [
        ...
        Output("custom-api-datasource-container", "style"),
        Output("infrastructure-container", "style"),
    ],
...
def toggle_datasource_type(datasource_type: str):
  ...
  if datasource_type == "looker":
    return {"display": "none"}, {"display": "block"}, {"display": "none"}, base_infra_style
  elif datasource_type == "custom_api":
    return {"display": "none"}, {"display": "none"}, {"display": "block"}, {"display": "none"}
  return {"display": "block"}, {"display": "none"}, {"display": "none"}, base_infra_style
...
@typed_callback(
    ...
    state=[
        ...
        State(AgentIds.Form.INPUT_CUSTOM_API_ENDPOINT, CP.VALUE),
    ],
...
def add_agent(
  ...
  try:
    ...
    config = AgentConfig(
        project_id=project if project else "custom",
