      ...
      children=[
          ...
          dmc.Stack(
              ...
              children=[
                      ...
                      children=[
                          ...
                          dmc.SegmentedControl(
                              ...
                              data=[
                                  ...
                                  {"label": "Custom Agent (API)", "value": "custom_api"},
                              ],
                              value="bq",
                              size="sm",
                              radius="md",
                  ...
                  # Custom Agent API Configuration
                  html.Div(
                      id="custom-api-datasource-container",
                      style={"display": "none"},
                      children=[
                          dmc.Stack(
                              gap="md",
                              children=[
                                  dmc.Text(
                                      "Custom API Connection Details", fw=500, size="sm"
                                  ),
                                  dmc.TextInput(
                                      label="API Endpoint URL",
                                      placeholder="https://your-api.com/query",
                                      id=AgentIds.Form.INPUT_CUSTOM_API_ENDPOINT,
                                      required=True,
                                      size="md",
                                  ),
                              ],
